...
\begin{frame}{代码与输出}
  \begin{itemize}
    ...
    \item 官方复现：\code{scripts/run\_official\_dola\_truthfulqa.sh}
    \item 实验结果：\code{outputs/local\_results\_summary.csv}
    \item 官方结果：\code{outputs/official\_dola\_truthfulqa\_summary.csv}
